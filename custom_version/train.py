...
class ExperimentManager:
    ...
    def train(self) -> None:
        ...
        for episode in range(1, max_episodes + 1):
            ...
            if episode % save_interval == 0:
                ...
                self.visualizer.plot_training_curves(implementation="custom")
        ...
        self.visualizer.plot_training_curves(implementation="custom")
        self.visualizer.save_metrics(implementation="custom")
    ...
    def save_checkpoint(self, episode) -> None:
        checkpoint_path = os.path.join(
            ...
            f"{self.exp_name}_custom_episode_{episode}.pkl"
        )
